...
public class CanadaAddress extends Address {
    ...
    public CanadaAddress(String recipient, String houseNumber, String streetName, String apartmentNumber, String city, String stateAbbreviation,  String postalCode, String country) {
